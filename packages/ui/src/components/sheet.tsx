  ...
  (
    ...
    <SheetPortal>
      ...
      >
        <div
          className={cn(
            "border w-full h-full bg-[#FAFAF9] dark:bg-[#121212] p-0 relative overflow-hidden rounded-md flex flex-col",
            className,
          )}
        >
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description
    ref={ref}
    className={cn("text-compact-medium text-subtitle p-4", className)}
    {...props}
  />
));
