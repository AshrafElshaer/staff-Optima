...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 p-4 text-center sm:text-left border-b",
      className,
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-row *:w-full *:sm:w-fit sm:justify-end space-x-2 px-4 py-3 border-t",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn("text-compact-large text-subtitle p-4", className)}
    {...props}
  />
));
