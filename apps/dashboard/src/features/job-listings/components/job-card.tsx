...
import { Megaphone01Icon, Menu03Icon, Edit01Icon, MoreHorizontalIcon, UserAdd01Icon, Delete01Icon } from "hugeicons-react";

import { HoverCardTrigger } from "@optima/ui/hover-card";

import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@optima/ui/card";
...
import { DropdownMenu,  DropdownMenuSeparator, DropdownMenuSubContent, DropdownMenuSubTrigger, DropdownMenuSub, DropdownMenuItem } from "@optima/ui/dropdown-menu";
...
interface JobCardProps {
  job: JobListing & { department: Department };
}

export function JobListingCard({ job }: JobCardProps) {
  return  <Card key={job.id} className=" bg-accent space-y-2">
